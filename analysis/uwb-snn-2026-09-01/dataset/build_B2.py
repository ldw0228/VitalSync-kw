...
# 회복 호흡은 무호흡 종료 직후 ~28초만 사용 (그 뒤는 평소 수준으로 복귀 — 실측 확인)
BLOCKS=[('평소 호흡',-140,-78),('느린 호흡',-78,-16),('무호흡',-16,16),
        ('회복 호흡',18,46),('운동',94,156),('운동 후 호흡',172,234)]
NAMES=[b[0] for b in BLOCKS]
TARGET=[10,10,14,16,10,10]
...
np.savez_compressed('dataset_B2.npz',X=X,y=y,g=g,rad=rad,names=np.array(NAMES))
